...
```{r, echo=FALSE, out.width='80%', fig.asp=.75, fig.align='center', fig.alt='Landmarks na mandibula de um roedor sigmodontíneo'}
knitr::include_graphics("images/Slogan_oficial_sologo.jpg")
```
